...
public class FootballPlayerRequestOutboxFixture {
    ...
    private record FootballPlayerOutboxBatchPreparedStatementSetter(List<Map<String, Object>> outboxes)
        ...
        public void setValues(PreparedStatement ps, int i) throws SQLException {
            ...
            ps.setString(2, (String) player.get("nationality"));
            ps.setString(3, (String) player.get("position"));
            ps.setString(4, (String) player.get("firstName"));
            ps.setString(5, (String) player.get("lastName"));
            ps.setString(6, (String) player.get("name"));
            ps.setString(7, (String) player.get("displayName"));
            ps.setDate(8, Date.valueOf((LocalDate) player.get("dateOfBirth")));
        }
